...
angular.module('niord.messages')
     ...
     *******************************************************************/
    .controller('UpdateStatusDialogCtrl', ['$scope', '$rootScope', 'growl', 'MessageService', 'DialogService', 'selection',
        function ($scope, $rootScope, growl, MessageService, DialogService, selection) {
            'use strict';
            $scope.isEditor = $rootScope.hasRole('editor');
            $scope.isAdmin = $rootScope.hasRole('admin');

            // Valid status transitions depending in role.
            // Admins can do anything.
            // Editors can only modify drafts and verified messages.
            ...
            } else if($scope.isEditor && !$scope.isAdmin){
                $scope.validStatuses = {
                    'DRAFT':     [ 'VERIFIED', 'DELETED' ],
                    'VERIFIED':  [ 'DRAFT', 'DELETED' ],
                    'PUBLISHED': [ ]
                };
            } else {
                console.error("unknown role, not admin or editor!");
            }
